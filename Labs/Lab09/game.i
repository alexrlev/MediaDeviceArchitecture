...
void updatePlayer() {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<6)))) {
        if (pikachu.worldRow > 0 && collisionmapBitmap[(((pikachu.worldRow - pikachu.rdel))*(256)+(pikachu.worldCol))]
         && collisionmapBitmap[(((pikachu.worldRow - pikachu.rdel))*(256)+((pikachu.worldCol + pikachu.width - pikachu.cdel)))]) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        if (pikachu.worldRow + pikachu.height < 256 && collisionmapBitmap[(((pikachu.worldRow + pikachu.height))*(256)+(pikachu.worldCol))]
         && collisionmapBitmap[(((pikachu.worldRow + pikachu.height))*(256)+((pikachu.worldCol + pikachu.width - pikachu.cdel)))]) {

         pikachu.worldRow+=pikachu.rdel;
            if (vOff < 96 && pikachu.screenRow > 160 / 2) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
        if (pikachu.worldCol > 0 && collisionmapBitmap[((pikachu.worldRow)*(256)+((pikachu.worldCol - pikachu.cdel)))]
        && collisionmapBitmap[(((pikachu.worldRow + pikachu.height - pikachu.rdel))*(256)+((pikachu.worldCol + pikachu.width)))]) {
   ...
   pikachu.worldCol-=pikachu.cdel;
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        if (pikachu.worldCol + pikachu.width < 256 && collisionmapBitmap[((pikachu.worldRow)*(256)+((pikachu.worldCol + pikachu.width)))]
        && collisionmapBitmap[(((pikachu.worldRow+pikachu.height - pikachu.rdel))*(256)+((pikachu.worldCol + pikachu.width)))]) {

            pikachu.worldCol+=pikachu.cdel;
            if (hOff < 16 && pikachu.screenCol > 240 / 2) {
