...
void update() {
 ...
 if ((bCol > 0) && (~(*(volatile unsigned short *)0x04000130) &((1<<5))))
  bCol--;
 if ((bCol + bWidth < 240) && (~(*(volatile unsigned short *)0x04000130) &((1<<4))))
  bCol++;
 if ((bRow > 0) && (~(*(volatile unsigned short *)0x04000130) &((1<<6))))
  bRow--;
 if ((bRow + bHeight < 160) && (~(*(volatile unsigned short *)0x04000130) &((1<<7))))
  bRow++;
 ...
 if (collision(gRow, gCol, gHeight, gWidth, bRow, bCol, bHeight, bWidth) == 1) {
  gRDel *= -1;
  gCDel *= -1;
 }
