...
void game() {
    ...
    drawString(145, 5, buffer, ((31) | (31)<<5 | (31)<<10));
    ...
    drawRect(145, 107, 8, 6, 0);
    drawChar(145, 107, ballsRemaining + '0', ((31) | (31)<<5 | (31)<<10));
...
void goToPause() {
    ...
    drawString(60, 105, "Pause", ((0) | (31)<<5 | (31)<<10));
...
void goToLose() {
    ...
    drawString(60, 108, "Lose", ((0) | (31)<<5 | (31)<<10));
