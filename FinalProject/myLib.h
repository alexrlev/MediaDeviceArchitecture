...
#define BG_PRIORITY(num)    ((num)<<0)
#define BG_CHARBLOCK(num)   ((num)<<2)
#define BG_SCREENBLOCK(num) ((num)<<8)
#define BG_4BPP             (0<<7)
#define BG_8BPP             (1<<7)
#define BG_SIZE_SMALL       (0<<14)  // 32x32 tiles, 256x256 pixels
#define BG_SIZE_WIDE        (1<<14)  // 64x32 tiles, 512x256 pixels
#define BG_SIZE_TALL        (2<<14)  // 32x64 tiles, 256x512 pixels
#define BG_SIZE_LARGE       (3<<14)  // 64x64 tiles, 512x512 pixels
