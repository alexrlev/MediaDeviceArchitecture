...
void goToStart() {
 ...
 drawString(20, 10, "Skeet Soccer", 0);
 drawHorizontalLine(28, 10, 72, 0);
 drawString(40, 10, "Press Start to Continue", ((31) | (31)<<5 | (31)<<10));
}
...
void goToInstr() {
 ...
 drawString(30, 10, "Press A to shoot soccer balls", ((31) | (31)<<5 | (31)<<10));
 drawString(40, 10, "Press Start to pause game", ((31) | (31)<<5 | (31)<<10));
 drawString(50, 10, "Don't let any balls enter the goal", ((31) | (31)<<5 | (31)<<10));
 drawString(70, 10, "Press Start to Begin!", ((31) | (31)<<5 | (31)<<10));
...
void goToGame() {
 ...
 drawString(140, 5, "Balls ", 0);
 drawString(150, 5, "Left: ", 0);
}
...
void game() {
 ...
 drawBox(150, 41, 8, 6, ((6) | (20)<<5 | (6)<<10));
    drawChar(150, 41, ballsRemaining + '0', 0);
...
void goToPause() {
 ...
 drawString(10, 10, "Pause", 0);
 drawString(30, 10, "Press Start to resume game", ((31) | (31)<<5 | (31)<<10));
 drawString(40, 10, "Prese Select to restart", ((31) | (31)<<5 | (31)<<10));
...
void goToWin() {
 ...
 drawString(10, 10, "You win!!", 0);
 drawString(30, 10, "Press Start to play again", ((31) | (31)<<5 | (31)<<10));
...
void goToLose() {
 drawBackground();
 drawBox(142, 41, 8, 6, ((6) | (20)<<5 | (6)<<10));

 drawString(10, 10, "You lose", 0);
 drawString(30, 10, "Press Start to play again", ((31) | (31)<<5 | (31)<<10));
