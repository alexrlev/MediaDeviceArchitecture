...
void drawPlayer() {
 ...
 drawBox(player.oldRow, player.oldCol, player.height, player.width, ((6) | (20)<<5 | (6)<<10));
...
void drawBullet(BULLET* b) {
 ...
 if(b->active) {
  drawBox(b->oldRow, b->oldCol, b->height, b->width, ((6) | (20)<<5 | (6)<<10));
...
void updateBall(BALL* b) {
 ...
 if (b->active) {
  ...
  if (collision(b->row, b->col, b->height, b->width,
   ...
   if ((player.col > 0) && (~((*(volatile unsigned short *)0x04000130)) &((1<<5))))
    player.col--;
   if ((player.col + player.width < 240) && (~((*(volatile unsigned short *)0x04000130)) &((1<<4))))
    player.col++;
  }
...
void drawBall(BALL* b) {
 ...
 if(b->active) {
  ...
  drawBox(b->row, b->col, b->height, b->width, ((31) | (31)<<5 | (31)<<10));


  drawBox((b->row + 1), (b->col + 4), 2, 2, 0);
  drawBox((b->row + 3), b->col, 2, 1, 0);
  drawBox((b->row + 6), (b->col + 3), 1, 2, 0);
